Parasol-org.Win-compliance Run Role
========================
...
- name: Execute tasks on servers
  hosts: servers
  roles:
    - role: parasol-org.win-compliance.run
      run_x: 42
```
...
```yaml
- name: Initialize the run role from parasol-org.win-compliance
  hosts: servers
  gather_facts: false
  tasks:
    - name: Trigger invocation of run role
      ansible.builtin.include_role:
        name: parasol-org.win-compliance.run
      vars:
        run_x: 42
```
